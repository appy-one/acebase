...
import { Storage, NodeNotFoundError } from './storage';
...
export function query(
    ...
    path: string, 
    query: Query, 
    options: QueryOptions = { snapshots: false, include: undefined, exclude: undefined, child_objects: undefined, eventHandler: event => {} }
