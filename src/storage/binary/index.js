...
class NodeReader {
    ...
    getChildTree() {
        ...
        return new btree_1.BinaryBPlusTree(this._treeDataReader.bind(this), 1024 * 100, // 100KB reads/writes
    ...
    if (nodeReader.recordInfo.hasKeyIndex) {
        ...
        const processOperations = async (retry = 0) => {
            ...
            try {
                ...
                tree = new btree_1.BinaryBPlusTree(nodeReader._treeDataReader.bind(nodeReader), 1024 * 100, // 100KB reads/writes
