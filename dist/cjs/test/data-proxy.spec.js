...
describe('DataProxy', () => {
    ...
    it('Proxy2', async () => {
        ...
        const book1 = { title: 'New book 1!', description: 'This is my first book' }, book2 = { title: 'New book 2', description: 'This is my second book' }, book3 = { title: 'New book 3', description: 'This is my third book' };
    ...
    it('OrderedCollectionProxy', async () => {
        ...
        const todo = (0, acebase_core_1.proxyAccess)(proxy.value);
        ...
        for (let i = 0; i < arr.length; i++) {
            const item = arr[i];
            expect(() => (0, acebase_core_1.proxyAccess)(item)).not.toThrow();
    ...
    it('proxy with cursor', async () => {
        const { db, removeDB } = await (0, tempdb_1.createTempDB)({ transactionLogging: true });
        const delay = () => new Promise(resolve => setTimeout(resolve, 1000));
...
//# sourceMappingURL=data-proxy.spec.js.map