...
describe('Data type', () => {
    ...
    it('reference', async () => {
        ...
        await db.ref('datatypes').update({ ref: new acebase_core_1.PathReference(refPath) });
        const snap = await db.ref('datatypes/ref').get();
        expect(snap.val()).toBeInstanceOf(acebase_core_1.PathReference);
...
//# sourceMappingURL=data-types.spec.js.map