...
},{"./data-index":38,"./node":37,"./query":40,"./storage":42,"./storage-acebase":38,"./storage-custom":41,"./storage-mssql":38,"./storage-sqlite":38,"acebase-core":12}],31:[function(require,module,exports){
/**
   ________________________________________________________________________________
...
},{"./data-index":38,"./node-value-types":36,"./storage":42,"acebase-core":12}],41:[function(require,module,exports){
...
},{"./node-info":34,"./node-lock":35,"./node-value-types":36,"./storage":42,"acebase-core":12}],42:[function(require,module,exports){
        ...
        this.indexes = {
            ...
            get(path, key = null) {
                ...
                return _indexes.filter(index => 
                    // index.state === DataIndex.STATE.READY &&
                    index.path === path &&
