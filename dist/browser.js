...
},{"./data-reference":8,"./debug":10,"./optional-observable":14,"./simple-colors":21,"./simple-event-emitter":22,"./type-mappings":26}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Api = void 0;
...
},{"./simple-event-emitter":22}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./data-reference":8,"./data-snapshot":9,"./id":11,"./optional-observable":14,"./path-info":16,"./path-reference":17,"./process":18,"./simple-event-emitter":22,"./utils":27}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./data-proxy":7,"./data-snapshot":9,"./id":11,"./optional-observable":14,"./path-info":16,"./subscription":24}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./simple-observable":23,"./utils":27,"rxjs":62}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./ascii85":3,"./partial-array":15,"./path-info":16,"./path-reference":17,"./utils":27}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./data-reference":8,"./data-snapshot":9,"./path-info":16,"./utils":27}],27:[function(require,module,exports){
...
},{"./partial-array":15,"./path-reference":17,"./process":18,"buffer":62}],28:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class NodeLocker {
    ...
    async lock(path, tid, forWriting = true, comment = '', options = { withPriority: false, noTimeout: false }) {
        ...
        if (path instanceof NodeLock) {
            ...
            const expiredLock = this._locks.find((l => l.tid === tid && l.state === exports.LOCK_STATE.EXPIRED));
            throw new NodeLockError(`lock on tid ${tid} has expired, not allowed to continue`, expiredLock !== null && expiredLock !== void 0 ? expiredLock : null);
        }
        else if (this._quit && !options.withPriority) {
            const refLock = this._locks.find((l => l.tid === tid && l.path === path));
            throw new NodeLockError(`Quitting`, refLock !== null && refLock !== void 0 ? refLock : null);
        }
        else {
    ...
    unlock(lockOrId, comment, processQueue = true) {
        ...
        if (i < 0) {
            const msg = `lock on "/${(_a = lock === null || lock === void 0 ? void 0 : lock.path) !== null && _a !== void 0 ? _a : '?'}" for tid ${(_b = lock === null || lock === void 0 ? void 0 : lock.tid) !== null && _b !== void 0 ? _b : '?'} wasn't found; ${comment}`;
            // debug.error(`unlock :: ${msg}`);
            throw new NodeLockError(msg, lock !== null && lock !== void 0 ? lock : null);
        }
...
},{"acebase-core":12}],42:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
async function createIndex(context, path, key, options) {
    ...
    if (existingIndex && rebuild !== true) {
        logger.info(`Index on "/${path}/*/${key}" already exists`.colorize(acebase_core_1.ColorStyle.inverse));
    ...
    try {
        ...
        context.logger.error(`Index build on "/${path}/*/${key}" failed: ${err.message} (code: ${err.code})`.colorize(acebase_core_1.ColorStyle.red));
        if (!existingIndex) {
...
},{"acebase-core":12}],48:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class CustomStorage extends index_js_1.Storage {
    ...
    async _init() {
        this.logger.info(`Database "${this.name}" details:`.colorize(acebase_core_1.ColorStyle.dim));
        this.logger.info(`- Type: CustomStorage`.colorize(acebase_core_1.ColorStyle.dim));
        this.logger.info(`- Path: ${this.settings.path}`.colorize(acebase_core_1.ColorStyle.dim));
        this.logger.info(`- Max inline value size: ${this.settings.maxInlineValueSize}`.colorize(acebase_core_1.ColorStyle.dim));
        this.logger.info(`- Autoremove undefined props: ${this.settings.removeVoidProperties}`.colorize(acebase_core_1.ColorStyle.dim));
    ...
    async _writeNode(path, value, options) {
        ...
        if (currentRow) {
            ...
            this.logger.info(`Node "/${path}" is being created`.colorize(acebase_core_1.ColorStyle.cyan));
            if (isArray) {
    ...
    async _deleteNode(path, options) {
        const pathInfo = acebase_core_1.PathInfo.get(path);
        this.logger.info(`Node "/${path}" is being deleted`.colorize(acebase_core_1.ColorStyle.cyan));
        ...
        this.logger.info(`Nodes ${deletePaths.map(p => `"/${p}"`).join(',')} are being deleted`.colorize(acebase_core_1.ColorStyle.cyan));
    ...
    async getNode(path, options) {
        ...
        try {
            const node = await (async () => {
                ...
                this.logger.info(`Read node "/${path}" and ${filtered ? '(filtered) ' : ''}descendants from ${descRows.length + 1} records`.colorize(acebase_core_1.ColorStyle.magenta));
...
},{"./errors.js":55,"./storage-settings.js":60,"./storage.js":61}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.createIndex = void 0;
...
class Storage extends acebase_core_1.SimpleEventEmitter {
    ...
    constructor(name, settings, env) {
        ...
        this.logger = (_a = env.logger) !== null && _a !== void 0 ? _a : new acebase_core_1.DebugLogger(env.logLevel, `[${name}${typeof settings.type === 'string' && settings.type !== 'data' ? `:${settings.type}` : ''}]`); // `├ ${name} ┤` // `[🧱${name}]`
    ...
    setSchema(path, schema, warnOnly = false) {
        ...
        const definition = new acebase_core_1.SchemaDefinition(schema, {
            warnOnly,
            warnCallback: (message) => this.logger.warn(message),
        });
...
},{"../assert.js":31,"../data-index/index.js":34,"../ipc/index.js":35,"../node-errors.js":38,"../node-info.js":39,"../node-value-types.js":41,"../promise-fs/index.js":43,"./errors.js":55,"./indexes.js":57,"acebase-core":12}],62:[function(require,module,exports){
