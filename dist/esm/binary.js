export function writeByteLength(bytes, index, length) {
...
export function readByteLength(bytes, index) {
...
export function writeSignedNumber(bytes, index, offset) {
...
export function readSignedNumber(bytes, index) {
...
export function writeSignedOffset(bytes, index, offset, large = false) {
    if (!large) {
...
export function readSignedOffset(bytes, index, large = false) {
    if (!large) {
